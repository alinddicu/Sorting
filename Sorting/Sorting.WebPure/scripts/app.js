/// <reference path="Drawing/MultiCanvasDrawer.ts"/>>
...
//	};
//}
//function drawSort(sort: Algorithms.SortBase): void {
...
function draw() {
    ...
    new Drawing.MultiCanvasDrawer(document, sortings, 10).Draw(arrayToSort);
}
