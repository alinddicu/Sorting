...
var arrayToSort = [9, 8, 7, 6, 5, 4, 3, 2, 1, 0];
...
var bubbleSort = new Algorithms.BubbleSort();
bubbleSort.execute(arrayToSort);
var insertionSort = new Algorithms.InsertionSort();
var result = insertionSort.execute(arrayToSort);
...
function drawSort(sort, canvas) {
    var canvasDrawer = new Drawing.CanvasDrawer(sort);
